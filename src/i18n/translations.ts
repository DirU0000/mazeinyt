...
export const translations: Record<Lang, Record<string, string>> = {
  ko: {
    ...
    'seo.board.description':
      '유튜브 트렌드 정보를 공유하고 사이트 건의사항을 남길 수 있는 게시판입니다.',
    ...
    'board.h1': '게시판',
    'board.desc':
      '유튜브 트렌드에 대한 정보를 서로 공유하고, 사이트에 대한 건의사항을 자유롭게 남겨주세요.',
    'board.cat.all': '전체',
    'board.cat.info': '정보 공유',
    'board.cat.suggestion': '건의사항',
    'board.cat.aria': '게시판 카테고리',
    'board.write': '글쓰기',
    'board.empty': '아직 글이 없습니다. 첫 글을 남겨보세요.',
    'board.error': '게시글을 불러오지 못했습니다: {msg}',
    'board.edited': '수정됨',
    'board.form.category': '분류',
    'board.form.nickname': '닉네임',
    'board.form.nicknamePlaceholder': '표시할 이름 (최대 20자)',
    'board.form.password': '비밀번호',
    'board.form.passwordPlaceholder': '수정·삭제 시 필요 (4자 이상)',
    'board.form.title': '제목',
    'board.form.titlePlaceholder': '제목을 입력하세요 (최대 100자)',
    'board.form.body': '내용',
    'board.form.bodyPlaceholder': '내용을 입력하세요',
    'board.form.submit': '등록',
    'board.form.submitting': '처리 중...',
    'board.form.cancel': '취소',
    'board.detail.back': '목록으로',
    'board.detail.edit': '수정',
    'board.detail.delete': '삭제',
    'board.detail.deleteConfirm':
      '정말 삭제하시겠습니까? 삭제하려면 작성 시 입력한 비밀번호를 입력하세요.',
  ...
  en: {
    ...
    'seo.board.description':
      'Share YouTube trend tips and post suggestions for the site.',
    ...
    'board.desc':
      'Share information about YouTube trends and leave suggestions for the site.',
    'board.cat.all': 'All',
    'board.cat.info': 'Info',
    'board.cat.suggestion': 'Suggestion',
    'board.cat.aria': 'Board category',
    'board.write': 'New post',
    'board.empty': 'No posts yet. Be the first to write one.',
    'board.error': 'Failed to load posts: {msg}',
    'board.edited': 'edited',
    'board.form.category': 'Category',
    'board.form.nickname': 'Nickname',
    'board.form.nicknamePlaceholder': 'Display name (max 20 chars)',
    'board.form.password': 'Password',
    'board.form.passwordPlaceholder': 'Needed to edit/delete (min 4 chars)',
    'board.form.title': 'Title',
    'board.form.titlePlaceholder': 'Enter a title (max 100 chars)',
    'board.form.body': 'Body',
    'board.form.bodyPlaceholder': 'Write your message',
    'board.form.submit': 'Post',
    'board.form.submitting': 'Working...',
    'board.form.cancel': 'Cancel',
    'board.detail.back': 'Back to list',
    'board.detail.edit': 'Edit',
    'board.detail.delete': 'Delete',
    'board.detail.deleteConfirm':
      'Delete this post? Enter the password you set when writing it.',
  ...
  ja: {
    ...
    'seo.board.description':
      'YouTubeトレンドの情報を共有し、サイトへの要望を投稿できる掲示板です。',
    ...
    'board.h1': '掲示板',
    'board.desc':
      'YouTubeトレンドに関する情報を共有し、サイトへの要望を自由に投稿してください。',
    'board.cat.all': 'すべて',
    'board.cat.info': '情報共有',
    'board.cat.suggestion': '要望',
    'board.cat.aria': '掲示板カテゴリ',
    'board.write': '投稿する',
    'board.empty': 'まだ投稿がありません。最初の投稿をしてみましょう。',
    'board.error': '投稿を読み込めませんでした: {msg}',
    'board.edited': '編集済み',
    'board.form.category': '分類',
    'board.form.nickname': 'ニックネーム',
    'board.form.nicknamePlaceholder': '表示名（最大20文字）',
    'board.form.password': 'パスワード',
    'board.form.passwordPlaceholder': '編集・削除に必要（4文字以上）',
    'board.form.title': 'タイトル',
    'board.form.titlePlaceholder': 'タイトルを入力（最大100文字）',
    'board.form.body': '本文',
    'board.form.bodyPlaceholder': '本文を入力してください',
    'board.form.submit': '投稿',
    'board.form.submitting': '処理中...',
    'board.form.cancel': 'キャンセル',
    'board.detail.back': '一覧へ',
    'board.detail.edit': '編集',
    'board.detail.delete': '削除',
    'board.detail.deleteConfirm':
      '本当に削除しますか？削除するには投稿時に設定したパスワードを入力してください。',
